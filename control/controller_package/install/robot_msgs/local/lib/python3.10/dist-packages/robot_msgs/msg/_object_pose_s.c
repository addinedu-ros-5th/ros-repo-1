...
bool robot_msgs__msg__object_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_msgs.msg._object_pose.ObjectPose", full_classname_dest, 38) == 0);
  }
  robot_msgs__msg__ObjectPose * ros_message = _ros_message;
  {  // detector_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "detector_id");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->detector_id = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // detected
  ...
  {  // ranges
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->ranges.data;
...
PyObject * robot_msgs__msg__object_pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_msgs.msg._object_pose");
  ...
  {  // detector_id
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->detector_id);
    {
      int rc = PyObject_SetAttrString(_pymessage, "detector_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // ranges
    ...
    if (ros_message->ranges.size > 0) {
      ...
      float * src = &(ros_message->ranges.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->ranges.size * sizeof(float));
      assert(data != NULL);
