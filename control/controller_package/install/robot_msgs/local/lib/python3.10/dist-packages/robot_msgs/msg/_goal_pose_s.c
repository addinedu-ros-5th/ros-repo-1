...
bool robot_msgs__msg__goal_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_msgs.msg._goal_pose.GoalPose", full_classname_dest, 34) == 0);
  }
  robot_msgs__msg__GoalPose * ros_message = _ros_message;
  {  // robot_id
...
{
  /* NOTE(esteve): Call constructor of GoalPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_msgs.msg._goal_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GoalPose");
