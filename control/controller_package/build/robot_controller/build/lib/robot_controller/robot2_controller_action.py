...
class MoveManager(Node):
    def __init__(self, ac_server):
        ...
        self.amcl_subscriber = self.create_subscription(PoseWithCovarianceStamped, '/amcl_pose2', self.amcl_pose_callback, 10)
    ...
    def object_detection(self, object_info):
        ...
        if object_info.detector_id == 'Mk.2':
...
class MoveActionServer(Node):
    def __init__(self):
        ...
        self.cmd_vel_publisher = self.create_publisher(Twist, '/base_controller/cmd_vel_unstamped2', 10)

        self.action_server = ActionServer(self, MoveToGoal,'/robot2_moving_path', self.execute_callback)
